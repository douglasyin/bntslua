...
BS13_clgicon={x=34,y=82,color=0xD1880B}   -- BS 13 challenge icon

BS16_land={x=34,y=82,color=0xFF2424} 
BS16_bay={x=34,y=82,color=0x3C96B0}
BS16_sea={x=34,y=82,color=0x3C96B0}

BS21_snow={x=12,y=1436,color=0xE6F0FA}
...
promo_popups = {
  {{x=934,y=782,color=0xED8300},{x=917,y=853,color=0xFFFFFF},{x=922,y=852,color=0x000000}}, -- Tier passed
  -- {{x=1286,y=252,color=0x931005},{x=950,y=630,color=0x606B4B},{x=1188,y=1748,color=0xD0FF5C}}, -- 4leg tank ad
  -- {{x=1278,y=222,color=0x931005},{x=1286,y=456,color=0x931005},{x=1012,y=543,color=0x00FF00}}, -- SP ad
  {{x=1285,y=241,color=0x940F08},{x=1300,y=364,color=0xF3F4EF},{x=922,y=301,color=0xBD9800}}  -- BS ad
  -- {{x=1276,y=204,color=0x900F05},{x=1268,y=298,color=0xF0F0F0},{x=1132,y=502,color=0x5DCC01}}, -- Anti-gravity tank ad
  -- {{x=1276,y=204,color=0x900F05},{x=1268,y=298,color=0xF0F0F0},{x=1020,y=1144,color=0xA9BB4B}}, -- BS18 ad
  -- {{x=1277,y=232,color=0x921005},{x=1291,y=365,color=0x8F0F05},{x=1314,y=334,color=0xF0F0F0}}, --Boss AD
  -- {{x=1335,y=122,color=0x981005},{x=1265,y=324,color=0xF0F0F0},{x=1269,y=330,color=0x921005}} -- nano unit AD
}
...
--             }
-- MM_BS13_logo={{x=468,y=1882,color=0xCB7E3B},                -- Boss Strike XIII mission button
--               {x=466,y=1909,color=0xFD3319},
--               {x=447,y=2002,color=0xC0A3AB}
--             }

-- MM_BS13_logo={{x=407,y=1932,color=0xB78990},                -- Boss Strike 20 mission button shuodajie
--               {x=390,y=1943,color=0xFAB743},
--               {x=471,y=1972,color=0x1257AA}
--             }

-- MM_BS13_logo={{x=457,y=1899,color=0x541F26},                -- Boss Strike 20 mission button raptor
--               {x=415,y=1927,color=0x49313D},
--               {x=447,y=1971,color=0xA01207}
--             }

MM_BS13_logo={{x=466,y=1879,color=0xD08237},                -- Boss Strike 21 mission button smokie
              {x=466,y=1909,color=0xEC3E1C},
              {x=495,y=1982,color=0x393A28}
            }
...
BS_RETREAT = {challenge=false,normal=false,BSland=false,BSbay=true,BSsea=true,BSsnow=true}
...
units = { bigfoot  = { {cat="critters",page=0,pos=2,num=5,delay=0,drag={} },             -- mammoth
          ...
          boss = { {cat="critters",page=0,pos=4,num=1,delay=0,drag={} },
                   {cat="vehicles",page=6,pos=11,num=7,delay=1000,drag={}}},

          bossagt = { {cat="vehicles",page=0,pos=3,num=9,delay=0,drag={} } },

          bossa = { {cat="critters",page=0,pos=4,num=1,delay=0,drag={} },
                   {cat="vehicles",page=7,pos=11,num=7,delay=500,drag={}}},

          boss4 = { {cat="critters",page=0,pos=4,num=1,delay=0,drag={} },
                   {cat="vehicles",page=5,pos=11,num=7,delay=500,drag={}}},

          bossk = { {cat="critters",page=0,pos=2,num=1,delay=0,drag={} },
                   {cat="vehicles",page=4,pos=11,num=7,delay=500,drag={}}},

          bossreal = { {cat="defense",page=0,pos=7,num=3,delay=0,drag={} },
                   -- {cat="infect",page=0,pos=6,num=1,delay=0,drag={} },
                   {cat="vehicles",page=5,pos=11,num=5,delay=500,drag={}}},

          bay = { {cat="navy",page=0,pos=9,num=3,delay=0,drag={} },  -- M10
                  {cat="hold",page=0,pos=5,num=6,delay=0,drag={}}
                },   
          ...
          invasion ={ {cat="navy",page=0,pos=8,num=6,delay=0,drag={} } },
...
attackSequence = { 
                ...
                bay  = {
                    {row=2,col=2,wpn=1,armrack=1,ammorack=1,drag=false,starget=-1,aim=true,asdrag={1,3,1,2}},
                    {row=2,col=3,wpn=1,armrack=1,ammorack=1,drag=false,starget=-1,aim=true,asdrag={1,3,1,4}},

                    {row=1,col=1,wpn=3,armrack=3,ammorack=2,drag=false,starget=-1,aim=true,asdrag={2,3,2,2}},
                    {row=1,col=2,wpn=3,armrack=3,ammorack=2,drag=false,starget=-1,aim=false,asdrag={}},
                    {row=1,col=3,wpn=3,armrack=3,ammorack=3,drag=false,starget=-1,aim=true,asdrag={2,3,2,4}},
                    {row=1,col=4,wpn=3,armrack=3,ammorack=2,drag=false,starget=-1,aim=false,asdrag={}},
                    {row=1,col=5,wpn=3,armrack=3,ammorack=2,drag=false,starget=-1,aim=true,asdrag={2,3,2,2}},
                    ...
                    {row=2,col=2,wpn=1,armrack=1,ammorack=1,drag=false,starget=-1,aim=false,asdrag={}},
                    {row=2,col=3,wpn=1,armrack=1,ammorack=1,drag=false,starget=-1,aim=false,asdrag={}},
                    {row=1,col=1,wpn=3,armrack=3,ammorack=2,drag=false,starget=-1,aim=false,asdrag={}},
                    {row=1,col=2,wpn=3,armrack=3,ammorack=2,drag=false,starget=-1,aim=false,asdrag={}},
                    {row=1,col=3,wpn=3,armrack=3,ammorack=3,drag=false,starget=-1,aim=false,asdrag={}},
                    {row=1,col=4,wpn=3,armrack=3,ammorack=2,drag=false,starget=-1,aim=false,asdrag={}},
                    {row=1,col=5,wpn=3,armrack=3,ammorack=2,drag=false,starget=-1,aim=false,asdrag={}},
                    {row=2,col=5,wpn=3,armrack=3,ammorack=2,drag=false,starget=-1,aim=false,asdrag={}},
                    {row=2,col=1,wpn=3,armrack=3,ammorack=2,drag=false,starget=-1,aim=false,asdrag={}},
                    ...
                    {row=2,col=2,wpn=1,armrack=1,ammorack=1,drag=false,starget=-1,aim=true,asdrag={}},
                    {row=2,col=3,wpn=1,armrack=1,ammorack=1,drag=false,starget=-1,aim=true,asdrag={}},
                    {row=1,col=1,wpn=3,armrack=3,ammorack=2,drag=false,starget=-1,aim=false,asdrag={}},
                    {row=1,col=2,wpn=3,armrack=3,ammorack=2,drag=false,starget=-1,aim=false,asdrag={}},
                    {row=1,col=3,wpn=3,armrack=3,ammorack=3,drag=false,starget=-1,aim=false,asdrag={}},
                    {row=1,col=4,wpn=3,armrack=3,ammorack=2,drag=false,starget=-1,aim=false,asdrag={}},
...
-------------------------
                ...
                boss = {
                    -- {row=1,col=3,wpn=1,armrack=1,ammorack=1,drag=false,starget=-1,aim=false,asdrag={}},         -- efence #1
                    {row=1,col=3,wpn=1,armrack=1,ammorack=1,drag=false,starget=-1,aim=false,asdrag={}},         -- efence #2
                    {row=1,col=3,wpn=3,armrack=2,ammorack=2,drag=false,starget=-1,aim=false,asdrag={}},         -- efence #3
                    {row=1,col=3,wpn=1,armrack=1,ammorack=1,drag=false,starget=-1,aim=false,asdrag={}},         -- efence #3
                    -- {row=1,col=4,wpn=1,armrack=1,ammorack=1,drag=false,starget=-1,aim=false,asdrag={}}, 
                    -- {row=2,col=5,wpn=2,armrack=2,ammorack=1,drag=false,starget=-1,aim=false,asdrag={}},   -- raider summoner
                ...
                bossagt = {
                    {row=1,col=1,wpn=3,armrack=3,ammorack=1,drag=false,starget=-1,aim=true,asdrag={2,3,1,2}},   
                    {row=1,col=2,wpn=3,armrack=3,ammorack=1,drag=false,starget=-1,aim=false,asdrag={}},         
                    {row=1,col=3,wpn=3,armrack=3,ammorack=1,drag=false,starget=-1,aim=true,asdrag={2,3,1,4}},   
                    {row=1,col=4,wpn=3,armrack=3,ammorack=1,drag=false,starget=-1,aim=true,asdrag={2,3,1,3}},
                    {row=1,col=5,wpn=3,armrack=3,ammorack=1,drag=false,starget=-1,aim=false,asdrag={}}, 
                    {row=2,col=1,wpn=3,armrack=3,ammorack=1,drag=false,starget=-1,aim=true,asdrag={2,3,1,3}},
                    {row=2,col=2,wpn=3,armrack=3,ammorack=1,drag=false,starget=-1,aim=false,asdrag={}},   -- 
                    {row=2,col=3,wpn=3,armrack=3,ammorack=1,drag=false,starget=-1,aim=true,asdrag={2,3,1,3}},
                    {row=2,col=4,wpn=3,armrack=3,ammorack=1,drag=false,starget=-1,aim=false,asdrag={}},

                    {row=1,col=1,wpn=3,armrack=3,ammorack=1,drag=false,starget=-1,aim=false,asdrag={}},
                    {row=1,col=2,wpn=3,armrack=3,ammorack=1,drag=false,starget=-1,aim=false,asdrag={}},
                    {row=1,col=3,wpn=3,armrack=3,ammorack=1,drag=false,starget=-1,aim=false,asdrag={}},
                    {row=1,col=4,wpn=3,armrack=3,ammorack=1,drag=false,starget=-1,aim=false,asdrag={}},
                    {row=1,col=5,wpn=3,armrack=3,ammorack=1,drag=false,starget=-1,aim=false,asdrag={}},
                    {row=2,col=1,wpn=3,armrack=3,ammorack=1,drag=false,starget=-1,aim=false,asdrag={}},
                    {row=2,col=2,wpn=3,armrack=3,ammorack=1,drag=false,starget=-1,aim=false,asdrag={}},
                    {row=2,col=3,wpn=3,armrack=3,ammorack=1,drag=false,starget=-1,aim=false,asdrag={}},
                    {row=2,col=4,wpn=3,armrack=3,ammorack=1,drag=false,starget=-1,aim=false,asdrag={}},
