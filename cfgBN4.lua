...
BS17_popups = {
  ...
  {{x=1284,y=256,color=0x901005},{x=694,y=524,color=0x28FBC8},{x=1012,y=542,color=0x00FF00}}, -- SP ad
  {{x=1280,y=220,color=0x8E0F05},{x=1106,y=968,color=0x1F4164},{x=1140,y=846,color=0xB86B10}},  -- BS ad
...
BS_RETREAT = {challenge=false,normal=false,BSland=false,BSbay=true,BSsea=true}
...
units = { bigfoot  = { {cat="critters",page=0,pos=2,num=5,delay=0,drag={} },             -- mammoth
          ...
          boss = { {cat="vehicles",page=0,pos=3,num=3,delay=0,drag={} },
                   {cat="vehicles",page=8,pos=11,num=7,delay=500,drag={}}},
...
-------------------------
                ...
                boss = {
                    -- {row=1,col=3,wpn=1,armrack=1,ammorack=1,drag=false,starget=-1,aim=false,asdrag={}},         -- efence #1
                    {row=1,col=2,wpn=3,armrack=3,ammorack=1,drag=false,starget=-1,aim=false,asdrag={}},         -- efence #2
                    {row=1,col=3,wpn=3,armrack=3,ammorack=1,drag=false,starget=-1,aim=false,asdrag={}},         -- efence #3
                    {row=1,col=4,wpn=3,armrack=3,ammorack=1,drag=false,starget=-1,aim=false,asdrag={}},         -- efence #3
                    -- {row=1,col=4,wpn=1,armrack=1,ammorack=1,drag=false,starget=-1,aim=false,asdrag={}}, 
                    -- {row=2,col=5,wpn=2,armrack=2,ammorack=1,drag=false,starget=-1,aim=false,asdrag={}},   -- raider summoner
